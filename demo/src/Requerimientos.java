...
public class Requerimientos {
    ...
    public String [][] mostrar() throws SQLException{
        ArrayList<Requerimiento_1> lista = new ElControladorDeRequerimientos();
        lista = controlador.consultaRequerimiento1();
    ...
    public String [][] mostrar2() throws SQLException{
        ...
        lista = controlador.consultaRequerimiento2();
        String matriz[][] = new String [lista.size()][5];
        for (int i = 0; i < lista.size(); i++) {
    ...
    public String [][] mostrar3() throws SQLException{
        ...
        ElControladorDeRequerimientos controlador = new ElControladorDeRequerimientos();
        lista = controlador.consultaRequerimiento3();
